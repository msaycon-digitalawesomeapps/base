...
import com.digitalawesome.clearchoice.databinding.ActivityWelcomeBinding
import com.digitalawesome.clearchoice.home.MainActivity
import com.digitalawesome.clearchoice.permissions.LocationAccessFragment
import com.digitalawesome.clearchoice.utils.displayAgeAlert
    ...
    private fun verifyAge() {
        if (userViewModel.isAgeVerified()) {
            ...
            displayAgeAlert(title = "Are you old enough\nto be here?",
                message = "You must be at least 21\nto enter this app",
                cancelButtonText = "No",
                cancelButtonAction = {},
